...
<button onclick="Quarterzip.open({ agentId: 'ii2rsb', workspaceToken: 'token', user: { email: 'jane@company.com', displayName: 'Jane Smith', id: 'test-user-123' } })">Open Agent (qwpbgz staging)</button>
